...
// FIX: ":path*" is Express-5 / path-to-regexp-v6 syntax and will not match
// as intended (or will throw at route-registration time) on Express 4,
// which is what this project's package.json most likely pins. "*" is the
// safe catch-all across both major versions.
